...
function runAsampleAPI() {
  ...
  if (s == "http://5.161.99.171:8080") {
    $.ajax({
      url:
        s + "/api/v1/apiseccheck/results?project-name=Online%20Banking%20REST%20API%20MXyV",
      method: "GET",
      dataType: "json",
      headers: {
    ...
    $.ajax({
      url:
        s + "/api/v1/apiseccheck/results?project-name=Online Banking%20REST%20API%20yrlJ",
      method: "GET",
      dataType: "json",
      headers: {
        "Content-Type": "application/json",
    ...
    $.ajax({
      url:
        s + "/api/v1/apiseccheck/results?project-name=Online%20Banking%20REST%20API%20RIBW",
      method: "GET",
      dataType: "json",
      headers: {
        "Content-Type": "application/json",
